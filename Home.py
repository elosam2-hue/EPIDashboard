...
with col2:
st.markdown('<div class="main-header-container"><h3 style="text-align: center; margin: 0;">South Ethiopia Immunization Data Triangulation Application</h3></div>', unsafe_allow_html=True)st.markdown('<p class="subtitle">Comprehensive analysis of vaccine administration and distribution data</p>', unsafe_allow_html=True)
with col3:
