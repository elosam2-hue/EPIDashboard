...
with col2:
st.markdown('<div class="main-header-container"><h3 style="text-align: center; margin: 0; color: white; font-family: Poppins, sans-serif;">South Ethiopia Immunization Data Triangulation Application</h3></div>', unsafe_allow_html=True)
